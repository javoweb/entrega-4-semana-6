...
from .entidades import Reserva, Usuario
#from .reglas import MinimoUnItinerario, RutaValida
from .excepciones import TipoObjetoNoExisteEnDominioApiGateWayExcepcion
from apigateway.seedwork.dominio.repositorios import Mapeador, Repositorio
from apigateway.seedwork.dominio.fabricas import Fabrica
from apigateway.seedwork.dominio.entidades import Entidad
...
class FabricaVuelos(Fabrica):
    def crear_objeto(self, obj: any, mapeador: Mapeador) -> any:
        if mapeador.obtener_tipo() == Reserva.__class__:
            ...
            raise TipoObjetoNoExisteEnDominioApiGateWayExcepcion()
